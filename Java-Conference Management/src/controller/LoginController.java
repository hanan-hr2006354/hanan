...
public class LoginController {//take from text fields and do stuff
	...
	@FXML
	void login(ActionEvent event) throws IOException {//shouldnt show sign up option at all
		UserAccount user = UserAccountContainer.login(username.getText(), password.getText());//can get if it logged in or not &returns
