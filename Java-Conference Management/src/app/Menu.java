...
@Override
	...
	public static void main(String[] args) throws Exception {
		...
		//Initial Available Conferences:
			...
			//Method for conference to not be repeated
//			Conference c1= new Conference("Programming language",LocalDate.parse("2023-11-01",formatter),LocalDate.parse("2023-11-01",formatter),rc1,"Musherib");
//		    ConferenceContainer.addConference(c1);
//			Conference c2= new Conference("Object Oriented",LocalDate.parse("2023-11-01",formatter),LocalDate.parse("2023-11-01",formatter),rc1,"Musherib");
//		    ConferenceContainer.addConference(c2);
//		    ConferenceContainer.displayAllconference();
